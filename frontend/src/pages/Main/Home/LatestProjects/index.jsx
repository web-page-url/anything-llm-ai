            ...
            <div className="relative">
                    ...
                    {getCurrentFeatures().map((feature, index) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <button className="w-full border-2 border-gray-900 text-gray-900 py-2 px-4 rounded hover:bg-gray-900 hover:text-white transition-all duration-200 font-medium">
                                    {feature.buttonText}
                                </button>
                            </div>
                        </div>
                ...
                {totalSlides > 1 && (
                    <>
                        <button
                            onClick={prevSlide}
                            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition-all duration-200 border border-gray-200"
                        >
                            ←
                        </button>
                        <button
                            onClick={nextSlide}
                            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition-all duration-200 border border-gray-200"
                        >
                            →
                        </button>
                    </>
